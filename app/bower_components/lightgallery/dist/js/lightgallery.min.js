    ...
    $.fn.lightGallery = function (options) {
        ...
        var setUp = {
            init: function () {
                ...
                setTimeout(function () {
                    $gallery.addClass('opacity open');
                }, 50);
            },
            structure: function () {
                //renan $('body').append('<div id="lg-outer" class="' + settings.addClass + '"><div id="lg-gallery"><div id="lg-slider"></div><img id="lg-close" class="lg-close-midia" style="float:right;margin-right:0px;margin-top:-5px;" src="img/ic_close_white_24px.svg"></div></div>').addClass
                $('#mdContentMidia').append('<div id="lg-outer" class="' + settings.addClass + '"><div id="lg-gallery"><div id="lg-slider"></div><img id="lg-close" class="lg-close-midia" style="float:right;margin-right:0px;margin-top:-5px;" src="img/ic_close_white_24px.svg"></div></div>').addClass
                ('light-gallery');
            ...
            buildThumbnail: function () {
                if (settings.thumbnail === true && $children.length > 1) {
                    ...
                    $gallery.append('<div style="margin-left:30px;" class="thumb-cont"> <div style="margin-left:0px;" class="thumb-inner"></div></div>');
                    ...
                    if (settings.dynamic) {
                        for (var i = 0; i < settings.dynamicEl.length; i++) {
                            ...
                            thumbList += '<div class="thumb"><img style="width:80px;height:70px;border-radius: 6px;" src="' + thumbImg + '" /><br><div style="color:black;font-size:9px;">'+settings.dynamicEl[i].thumbDate.split('T')[1].replace('Z', '')+'</div></div>'; 
                        }
                    } else {
                        $children.each(function () {
                            ...
                            thumbList += '<div class="thumb"><img style="width:80px;height:70px;border-radius: 6px;" src="' + thumbImg + '" /></div>';
                        });
                    }
            ...
            slide: function (index) {
                ...
                //para tds video e start ativo

                for(var i = 0; i < $('video').length; i++){
                    var value = $('video')[i].id;
                    if('video'+index == value){
                        $('#video'+i)[0].play();
                    }else{
                        if($('#video'+i)[0])
                        $('#video'+i)[0].pause();
